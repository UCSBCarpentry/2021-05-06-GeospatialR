...
humandate: "May 6-7, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Torin White", "Camila Vargas-Poulsen", "Greg Janee"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Kristi Liu", "Renata Curty", "Amelia Meyer", "Ian Lessing"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2021-05-06-IntroR  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "146980587895"  # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<a href="https://www.timeanddate.com/worldclock/fixedtime.html?msg=UCSB+Carpentry+IntroR&iso=20210416T08&p1=137">Check what time registration opens in your time 
zone</a>
